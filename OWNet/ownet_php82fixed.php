...
const OWNET_DEFAULT_HOST = '127.0.0.1';
const OWNET_DEFAULT_PORT = 4304;
const OWNET_LINK_TYPE_SOCKET = 0;
const OWNET_LINK_TYPE_STREAM = 1;
const OWNET_LINK_TYPE_TCP = 0;
const OWNET_LINK_TYPE_UDP = 1;
/*
...
*/
const OWNET_MSG_ERROR = 0;
const OWNET_MSG_NOP = 1;
const OWNET_MSG_READ = 2;
const OWNET_MSG_WRITE = 3;
const OWNET_MSG_DIR = 4;
const OWNET_MSG_SIZE = 5;
const OWNET_MSG_PRESENCE = 6;
const OWNET_MSG_DIR_ALL = 7;
const OWNET_MSG_READ_ANY = 99999;
